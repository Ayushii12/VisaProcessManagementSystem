...
INSERT ALL
    ...
    INTO F23_S001_T1_Book (ISBN, BookName, AuthorID, Price, PublishingCompany) VALUES (9781234567920, 'The Enigma Code', 7 , 24.99, 'Simon & Schuster')
    ...
    INTO F23_S001_T1_Book (ISBN, BookName, AuthorID, Price, PublishingCompany) VALUES (9781234568019, 'Stardust Lullaby', 16 , 22.50, 'Simon & Schuster')
    ...
    INTO F23_S001_T1_Book (ISBN, BookName, AuthorID, Price, PublishingCompany) VALUES (9781234568101, 'The Velvet Mirage', 25 , 21.25, 'Simon & Schuster')
    ...
    INTO F23_S001_T1_Book (ISBN, BookName, AuthorID, Price, PublishingCompany) VALUES (9781234568194, 'The Enchanted Codex', 34, 21.75, 'Simon & Schuster')
    ...
    INTO F23_S001_T1_Book (ISBN, BookName, AuthorID, Price, PublishingCompany) VALUES (9781234568378, 'Eternal Whispers', 42, 23.50, 'Simon & Schuster')
    ...
    INTO F23_S001_T1_Book (ISBN, BookName, AuthorID, Price, PublishingCompany) VALUES (9781234568477, 'Eternal Twilight Sonata', 34, 21.25, 'Simon & Schuster')
    ...
    INTO F23_S001_T1_Book (ISBN, BookName, AuthorID, Price, PublishingCompany) VALUES (9781234568538, 'The Velvet Mirage', 40, 25.50, 'Simon & Schuster')
...
WHERE Store_ID IS NOT NULL;
 ...
 -- Customers
INSERT ALL
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (1, 'Alice', '', 'Johnson', 'y', TO_DATE('1990-05-15', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (3, 'Eva', '', 'Martinez', 'y', TO_DATE('1988-11-10', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (5, 'Sophie', '', 'Garcia', 'y', TO_DATE('1980-07-18', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (7, 'Ava', '', 'Brown', 'y', TO_DATE('1995-12-05', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (9, 'Olivia', '', 'Chen', 'y', TO_DATE('1998-04-20', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (11, 'Emily', '', 'Davis', 'y', TO_DATE('1991-09-08', 'YYYY-MM-DD'))
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (12, 'William', '', 'Johnson', 'n', TO_DATE('1986-01-17', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (14, 'Benjamin', '', 'Martinez', 'n', TO_DATE('1993-08-28', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (17, 'Amelia', '', 'Lee', 'y', TO_DATE('1996-02-25', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (20, 'Alexander', '', 'Wang', 'n', TO_DATE('1985-03-27', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (22, 'Daniel', '', 'Johnson', 'n', TO_DATE('1980-09-08', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (24, 'Ava', '', 'Nguyen', 'n', TO_DATE('1997-04-18', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (26, 'Sophie', '', 'Lee', 'n', TO_DATE('1989-10-26', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (31, 'Aria', '', 'Johnson', 'y', TO_DATE('1983-11-10', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (34, 'Grayson', '', 'Lee', 'n', TO_DATE('1982-09-30', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (36, 'Mason', '', 'Kim', 'n', TO_DATE('1984-02-14', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (38, 'Liam', '', 'Davis', 'n', TO_DATE('1980-06-12', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (43, 'Zoe', '', 'Brown', 'y', TO_DATE('1994-09-08', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (48, 'Elena', '', 'Nguyen', 'n', TO_DATE('1995-12-01', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (52, 'Sophia', '', 'Kim', 'n', TO_DATE('1981-03-27', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (54, 'Aria', '', 'Davis', 'n', TO_DATE('1989-09-08', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (56, 'Emma', '', 'Nguyen', 'n', TO_DATE('1980-04-18', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (60, 'Ava', '', 'Kim', 'n', TO_DATE('1984-02-14', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (63, 'Liam', '', 'Johnson', 'y', TO_DATE('1980-11-10', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (66, 'Isabella', '', 'Lee', 'n', TO_DATE('1990-09-30', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (70, 'James', '', 'Davis', 'n', TO_DATE('1986-06-12', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (73, 'Sophia', '', 'Garcia', 'y', TO_DATE('1985-05-22', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (76, 'Henry', '', 'Kim', 'n', TO_DATE('1982-12-02', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (78, 'Liam', '', 'Davis', 'n', TO_DATE('1996-06-21', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (82, 'Daniel', '', 'Lee', 'n', TO_DATE('1992-05-30', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (86, 'Sophie', '', 'Davis', 'n', TO_DATE('1987-04-18', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (89, 'Emma', '', 'Garcia', 'y', TO_DATE('1980-12-01', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (91, 'Aria', '', 'Brown', 'y', TO_DATE('1990-04-20', 'YYYY-MM-DD'))
    ...
    INTO F23_S001_T1_CUSTOMER (CustomerID, fname, mname, lname, MembershipStatus, DateOfBirth) VALUES (94, 'Grayson', '', 'Davis', 'n', TO_DATE('1986-03-25', 'YYYY-MM-DD'))
...
SELECT
    ...
    TRUNC(SYSDATE - DBMS_RANDOM.VALUE * 365 * 30) + 1 + INTERVAL '1' YEAR AS ExpiryDate
...
-- Book Genres
INSERT ALL
    INTO F23_S001_T1_BOOK_GENRE (ISBN, Genre) VALUES (9780553103540, 'Fantasy')
    ...
    INTO F23_S001_T1_BOOK_GENRE (ISBN, Genre) VALUES (9781234567913, 'Fantasy')
    ...
    INTO F23_S001_T1_BOOK_GENRE (ISBN, Genre) VALUES (9781234568057, 'Fantasy')
    ...
    INTO F23_S001_T1_BOOK_GENRE (ISBN, Genre) VALUES (9781234568118, 'Fantasy')
    ...
    INTO F23_S001_T1_BOOK_GENRE (ISBN, Genre) VALUES (9781234568224, 'Fantasy')
    ...
    INTO F23_S001_T1_BOOK_GENRE (ISBN, Genre) VALUES (9781234568323, 'Fantasy')
    ...
    INTO F23_S001_T1_BOOK_GENRE (ISBN, Genre) VALUES (9781234568439, 'Fantasy')
    ...
    INTO F23_S001_T1_BOOK_GENRE (ISBN, Genre) VALUES (9781234568521, 'Fantasy')
    ...
    INTO F23_S001_T1_BOOK_GENRE (ISBN, Genre) VALUES (9781234568590, 'Fantasy')
    ...
    INTO F23_S001_T1_BOOK_GENRE (ISBN, Genre) VALUES (9781234568620, 'Fantasy')
SELECT * FROM dual;
...
SELECT si.ISBN, s.Store_ID
FROM F23_S001_T1_STOCKED_IN si
JOIN F23_S001_T1_INVENTORY i ON si.InventoryID = i.InventoryID
JOIN F23_S001_T1_STORE s ON i.InventoryID = s.Inventory_ID
FETCH FIRST 200 ROWS ONLY;


-- Link customers with books
INSERT INTO F23_S001_T1_BUYS (CustomerID, ISBN)
SELECT CustomerID, ISBN
FROM F23_S001_T1_CUSTOMER, F23_S001_T1_SOLD_BY
LIMIT 200;
...
FROM 
    F23_S001_T1_CUSTOMER C
    LEFT JOIN F23_S001_T1_MEMBERSHIP_CARD M ON C.CustomerID = M.CustomerID
    LEFT JOIN F23_S001_T1_STORE S ON DBMS_RANDOM.VALUE < 0.5;