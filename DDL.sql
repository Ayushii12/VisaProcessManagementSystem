...
-- Create schema
CREATE USER TEAM1 IDENTIFIED BY password;
GRANT CONNECT, RESOURCE TO TEAM1;

-- Switch to TEAM1 schema
ALTER SESSION SET CURRENT_SCHEMA = TEAM1;
...
CREATE TABLE F23_S001_T1_EMPLOYEE (
  EmployeeID NUMBER CONSTRAINT Employee_PK PRIMARY KEY,
  Title VARCHAR2(30) NOT NULL ,
  fname VARCHAR2(20) NOT NULL ,
  mname VARCHAR2(20) ,
  lname VARCHAR2(20) NOT NULL ,
  Store_ID NUMBER CONSTRAINT Employee_FK REFERENCES F23_S001_T1_STORE(Store_ID)
);
...
CREATE TABLE F23_S001_T1_PURCHASES_FROM (
  ...
  Offer CHAR(1) CONSTRAINT Offer_Check_PF CHECK (Offer IN ('A', 'B', 'C')),
  PurchaseDate DATE,
...
ADD CONSTRAINT Employee_Store_FK FOREIGN KEY (Store_ID) REFERENCES F23_S001_T1_STORE(Store_ID);
